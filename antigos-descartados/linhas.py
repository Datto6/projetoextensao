import pandas as pd
#retorna um arquivo csv com separador de virgula, com as linhas e suas respectivas lotacoes em horarios 00h, 01h, .... 23h
...
tabela = respostas.groupby(['Linha', 'hora']).size().unstack(fill_value=0) #agrupando por numero de carro, e hora 
...
tabela.to_csv('outputestacoes.csv', index=False) 
